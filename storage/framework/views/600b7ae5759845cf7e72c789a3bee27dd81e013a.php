        ...
        <div id="hd_info">
            <div id="cnts">
                ...
                <div id="login_area">
                    ...
                    <span id="span_userinfo"> <?php if(session('User')): ?> <a href=""> <?php echo e(session('User')); ?></a>·<a id="user_nav_blog_link" href="<?php echo e(url('home/list')); ?>">我的博客</a>·<a href="/home/logout">退出</a> <?php else: ?> [<a href="<?php echo e(URL('home/login')); ?>"> 登陆 </a>·<a href="<?php echo e(url('home/register')); ?>" onclick="register();return false">注册</a>]</span><?php endif; ?>
