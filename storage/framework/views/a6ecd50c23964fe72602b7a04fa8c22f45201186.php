                ...
                <div class="box-body">
                  <table class="table table-bordered">
                    ...
                    <tr>
                      ...
                      <td><a href="<?php echo e(url('/home/details')); ?>/<?php echo e($v->id); ?>"><?php echo e($v->title); ?></td>
                      <td><?php echo e($v->author); ?></td>
                      <td><?php echo e($v->addtime); ?></td>
                      <td class="btn btn-primary btn-xs"><?php if($v->status=='3'): ?>待审核 <?php elseif($v->status=='1'): ?>已通过 <?php else: ?>未通过 <?php endif; ?></td>
        
                      <td><button onclick="doDel(<?php echo e($v->cid); ?>)" class="btn btn-xs btn-danger">删除</button>
