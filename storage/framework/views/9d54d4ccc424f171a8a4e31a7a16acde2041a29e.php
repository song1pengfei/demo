...
<html><!--<![endif]-->
    ...
    <!-- 全局顶部导航栏 -->
		...
		<!-- 左上方 Logo -->
			<a class="logo" href="<?php echo e(url('home')); ?>"><img src="<?php echo e(asset('images/logo_small.gif')); ?>" alt="Logo"></a>

			<!-- 右上角 -->
			<!-- 登录显示写文章 -->
			<a class="btn write-btn" target="_blank" href="<?php echo e(url('home/list')); ?>">
			<i class="iconfont ic-write"></i>我的博客</a>

		<!-- 如果用户登录，显示下拉菜单 -->
			<div class="user">
				<div data-hover="dropdown">
					<a class="avatar" href="http://www.jianshu.com/u/ebd83d2a2318"><img src="<?php echo e(env('QINIU_IMG')); ?><?php echo e($list->pic); ?>" alt="120"></a>
				</div>
				<ul class="dropdown-menu">
					<li>
						<a href="<?php echo e(url('home/list')); ?>">
					...
					<li>
						<a rel="nofollow" data-method="delete" href="<?php echo e(URL('home/logout')); ?>">
	...
	<div class="container setting">
		<div class="row">
			<div class="aside">
				<ul>
					<li class="active">
						<a href="<?php echo e(url('home/personal')); ?>">
					...
					<li class="active">
						<a href="<?php echo e(url('home/detail')); ?>">
						<div class="setting-icon">
							<i class="iconfont ic-settings-basic"></i>
						</div> 
						<span>文章管理</span> 
