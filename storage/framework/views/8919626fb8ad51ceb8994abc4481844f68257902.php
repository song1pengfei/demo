...
<!-- saved from url=(0028)http://www.cnblogs.com/fnxz/ -->
	...
	<head>
		...
		<title><?php echo e(session('homeuser')->account); ?></title>
	...
	<body>
		...
		<h1><a id="Header1_HeaderTitle" class="headermaintitle" href="<?php echo e(url('home/personal')); ?>"><?php echo e(session('homeuser')->account); ?></a></h1>
		...
		<ul id="navList">
			<li><a id="blog_nav_sitehome" class="menu" href="<?php echo e(url('home')); ?>">博客园</a></li>
			<li><a id="blog_nav_myhome" class="menu" href="<?php echo e(url('home/list')); ?>">首页</a></li>
			<li><a id="blog_nav_newpost" class="menu" rel="nofollow" href="<?php echo e(url('home/detail/create')); ?>">发布</a></li>
...
<!--done-->
			...
			<div class="postTitle">
					<a id="homepage1_HomePageDays_DaysList_ctl00_DayList_TitleUrl_0" class="postTitle2" href="http://www.cnblogs.com/fnxz/p/7086949.html"><?php echo e($v->title); ?></a>
			</div>
			<div class="postTitle">
					<a id="homepage1_HomePageDays_DaysList_ctl00_DayList_TitleUrl_0" class="postTitle2" href="http://www.cnblogs.com/fnxz/p/7086949.html"><?php echo e($v->picname); ?></a>
			</div>
			<div class="postTitle">
					<a id="homepage1_HomePageDays_DaysList_ctl00_DayList_TitleUrl_0" class="postTitle2" href="http://www.cnblogs.com/fnxz/p/7086949.html"><?php echo e($v->author); ?></a>
			</div>
			<div class="clear"></div>
		...
		<div class="newsItem">
			...
			<div id="blog-news">
				<div id="profile_block">
					昵称：<a href="http://home.cnblogs.com/u/fnxz/"><?php echo e(session('homeuser')->account); ?></a><br>
		...
		<!--done-->
			<?php echo e(session('homeuser')->account); ?>
