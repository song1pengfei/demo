;
  ...
  <?php $__env->startSection('content'); ?>
			...
			<form class="form-horizontal" action="<?php echo e(URL('home/personal/update')); ?>/<?php echo e($list->userid); ?>" method="post" enctype="multipart/form-data">
			...
			<div class="col-xs-16 col-xs-offset-8 main">
				...
				<tr>
					<td class="top-line">
						<div class="avatar">
							<img src="<?php echo e(env('QINIU_IMG')); ?><?php echo e($list->pic); ?>">
