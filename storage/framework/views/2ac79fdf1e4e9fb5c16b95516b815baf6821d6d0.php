...
<!-- saved from url=(0028)http://www.cnblogs.com/fnxz/ -->
	...
	<head>
		...
		<title><?php echo e(session("User")); ?>}</title>
	...
	<body>
		...
		<!--done-->
		<h1><a id="Header1_HeaderTitle" class="headermaintitle" href="<?php echo e(url('home/personal')); ?>"><?php echo e(session('User')); ?></a></h1>
		<h2></h2>
		...
		<ul id="navList">
			...
			<li><a id="blog_nav_newpost" class="menu" rel="nofollow" href="<?php echo e(url('home/list/create')); ?>">发布</a></li>
