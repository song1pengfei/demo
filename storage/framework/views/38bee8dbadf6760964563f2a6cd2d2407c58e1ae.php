...
<p>
<?php if(session('User')): ?>
昵称：<input type="text" id="tbCommentAuthor" class="author" disabled="disabled" size="50" value="<?php echo e(session('User')->account); ?>">
<?php endif; ?>
</p>
...
昵称:<?php echo e(session('User')->account); ?>	
...
<?php if(session('User')): ?>
	<div id="blog-news"></a><div id="profile_block">昵称<?php echo e(session('User')->account); ?><br></div></div>
<?php endif; ?>
</div>
