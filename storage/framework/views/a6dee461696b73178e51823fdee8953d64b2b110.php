...
<li><a id="blog_nav_myhome" class="menu" href="<?php echo e(URL('home/list')); ?>">列表</a></li>
<li></li>
</ul>
		<div class="blogStats">			
		</div><!--end: blogStats -->
...
<div id="topics">
	<div class="post">
		<h1 class="postTitle">
			<a id="cb_post_title_url" class="postTitle2" href="http://www.cnblogs.com/f-ck-need-u/p/7100336.html"><?php echo e($ve->title); ?></a>
		</h1>
		<div class="clear"></div>
		<div class="postBody">
...
昵称：<input type="text" id="tbCommentAuthor" class="author" disabled="disabled" size="50" value="<?php echo e(session('homeuser')->account); ?>">
<?php endif; ?>
</p>
...
昵称:<?php echo e(session('homeuser')->account); ?>	
...
<script>
 function DoSubmit(){
	 $("#answertable").show();
	 $.ajax({
	  url:'<?php echo e(URL('home/discusstab')); ?>', 
	  type:'post',
	  data:$("#dd").serialize(),
	  dataType:'json',
	  async:true,
...
<?php if(session('homeuser')): ?>
	<div id="blog-news"></a><div id="profile_block">昵称:<?php echo e(session('homeuser')->account); ?><br></div></div>
<?php endif; ?>
</div>
