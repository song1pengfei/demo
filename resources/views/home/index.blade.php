        ...
        <div id="header_block">
            <div id="logo">
                <h1>
                    ...
                    <a href="" title="开发者的网上家园"><img src="{{asset('images/logo_small.gif')}}"
...
<div class="digg">
    <div class="diggit" > 
	<span class="diggnum" id="digg_count_7080165">{{$v->id}}</span>
	</div>
	<div class="clear"></div>
...
<div class="post_item_body">
	<h3><a class="titlelnk" href="" target="_blank">{{$v->title}}</a></h3>    
       ...
       <div class="post_item_foot">                    
            <a href="http://www.cnblogs.com/sunsky303/" class="lightblue">{{$v->author}}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a> 发布于 {{$v->addtime}}
