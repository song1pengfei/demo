...
<!--done-->
			...
			<div class="postTitle">
					<a id="homepage1_HomePageDays_DaysList_ctl00_DayList_TitleUrl_0"  href="http://www.cnblogs.com/fnxz/p/7086949.html">{{$v->title}}</a>
			</div>
			<!--<div class="postTitle">
            ...
            <div class="postTitle">
                    <a id="homepage1_HomePageDays_DaysList_ctl00_DayList_TitleUrl_0" class="postTitle2" href="{{url('/home/details')}}/{{$v->id}}"><?php echo mb_substr(htmlspecialchars_decode($v['content']),0,150,"utf-8");?></a>
            </div>
			<div class="clear"></div>
			<div class="postDesc">posted @ 2017-06-27 20:15 冯强0_0 阅读(4) 评论(0)  
					<a href="{{url('/home/details')}}/{{$v->id}}" rel="nofollow">阅读全文</a></div>
			<div class="clear"></div>
