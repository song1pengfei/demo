...
<div class="center-block body-content">
	...
	<!--表单-->
    <form class="form-horizontal col-sm-8 form-padding" role="form" id="registerForm" method="post" action="{{URL('home/add')}}" novalidate="novalidate" name="myform" onsubmit="return doSubmit()";>
